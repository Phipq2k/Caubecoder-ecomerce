        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/contact-information')}}">Thông tin website</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/manager-banner')}}">Danh sách Banner</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/list-category-post')}}">Danh sách danh mục bài viết</a></li>
                    </ul>
                </li>
...
{{-- Ck editor --}}
<script type="text/javascript">
	CKEDITOR.replace('ckeditorProductAdd');
