            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            <li><a href="{{URL::to('/favorite-list')}}"><i class="fa fa-star"></i> Yêu thích</a></li>
                            <li><a href="{{URL::to('/checkout')}}"><i class="fa fa-crosshairs"></i> Thanh toán</a></li>
                            @if (Session::get('customerId'))
                            <li><a href="{{URL::to('/order-history')}}"><i class="fa fa-book"></i> Lịch sử đơn hàng</a></li>
                            ...
                            @endif
                            <li class="li-cart">
                                <a title="Giỏ hàng" style="font-size:30px" href="{{URL::to('/show-cart-product')}}"><i class="fa fa-shopping-cart"></i></a>
                ...
                <div class="col-sm-9">
                    ...
                    <div class="mainmenu pull-left">
                        <ul style="margin: 0 0 0 10px" class="nav navbar-nav collapse navbar-collapse">
                            <li><a href="{{URL::to('/home')}}" class="menu-home">Trang chủ</a></li>
                            <li class="dropdown"><a>Sản phẩm<i class="fa fa-angle-down"></i></a>
                                ...
                                @else
                                <li><a class="menu-home" href="{{url('/danh-muc-san-pham/'.$cate->category_slug)}}">{{$cate->category_name}}</a></li>
                                @endif           	
                                @endforeach
                                </ul>
                            </li> 
                            <li class="dropdown"><a>Blog<i class="fa fa-angle-down menu-home"></i></a>
                                <ul role="menu" class="sub-menu">
                                    @foreach ($categoryPost as $key => $catePost)
                                        <li><a class="menu-home" href="{{url('/blog/'.$catePost->cate_post_slug)}}">{{$catePost->cate_post_name}}</a></li>        	
                                    @endforeach
                                </ul>
                            ...
                            <li ><a class="menu-home" href="{{URL::to('/contact')}}">Liên hệ</a></li>
                        </ul>
                    </div>
                </div>
